...
urlpatterns = [
    ...
    path('protocols/', views.dashboard_protocols, name='dashboard-protocols'),
    path('protocols/<uuid:protocol_id>/', views.dashboard_protocol_detail, name='dashboard-protocol-detail'), 
]